...
public class learningGraphDatabaseGenerator {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		String inputFilePath = CheckURL.pathToContent + File.separator +  "learningGraph.xml";
		String outputFilePath = CheckURL.pathToContent + File.separator +  "nodesDatabase.js";
	    ...
	    for (int i=0; i<learningConceptList.size(); i++) {
	    	...
	    	input += "{id:"+idNode+", label:''" + ", name:''"
	    			+", x:"+lc.m_xPos+", y:"+lc.m_yPos
	    			+", category:'learningConcept'},\n";
	    	input += "{id:"+idHallow+", label:''" + ", name:''"
	    			+", x:"+lc.m_xPos+", y:"+lc.m_yPos
	    			+", category:'highlightLearningConcept'},\n";
	    	input += "{id:"+idNodeWithLabel+", label:'"+lc.m_name + "', name:'"+lc.m_id
	    			+"', x:"+lc.m_xPos+", y:"+lc.m_yPos
