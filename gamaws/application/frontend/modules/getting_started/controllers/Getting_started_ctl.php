 ...
 * --------------------------------------------------
 */
class Getting_started_ctl extends MX_Controller
{
	...
	{
		parent::__construct();
		$this->class = "Getting_started_ctl";
		$this->module = "getting_started";
	}
	...
	public function index()
	{
		...
		$this->template->write_view("content","getting_started_view");
