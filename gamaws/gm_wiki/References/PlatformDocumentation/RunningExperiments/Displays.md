...
GAMA allows modelers to [define several and several kinds of displays](tutorials#DefiningDisplaysGeneralities) in a [GUI experiment](tutorials#DefiningGUIExperiment):
  * java 2D displays
  * OpenGL displays
...
* [Displays](references#displays)
	* [Classical displays (java2D)](references#classical-displays-java2d)
	* [OpenGL displays](references#opengl-displays)
...
![images/display-java2D.png](gm_wiki/resources/images/runningExperiments/display-java2D.png){.img-responsive}
...
![images/display-sidebar-overlay.png](gm_wiki/resources/images/runningExperiments/display-sidebar-overlay.png){.img-responsive}
...
![images/display-OpenGL.png](gm_wiki/resources/images/runningExperiments/display-OpenGL.png){.img-responsive}

In addition, the bottom overlay bar provides the Camera position in 3D.

### FreeFly camera commands ## {#freefly-camera-commands}
...
### ArcBall camera commands ## {#arcball-camera-commands}
