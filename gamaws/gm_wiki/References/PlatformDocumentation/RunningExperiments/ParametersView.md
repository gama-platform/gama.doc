...
In the case of an [experiment](tutorials#DefiningGUIExperiment), the modeler can [define the parameters](tutorials#DefiningParameters) he wants to be able to modify to explore the simulation, and thus the ones he wants to be able to display and alter in the GUI interface.
...
* [Parameters View](references#parameters-view)
	* [Built-in parameters](references#built-in-parameters)
	* [Parameters View](references#parameters-view)
	* [Modification of parameters values](references#modification-of-parameters-values)


## Built-in parameters ## {#built-in-parameters}
Every [GUI experiment](tutorials#DefiningGUIExperiment) displays a pane named "Parameters" containing at least two built-in parameters related to the random generator:
  * the Random Number Generator, with a choice between 3 RNG implementations,
  * the Random Seed

![images/parameters_built_in.png](gm_wiki/resources/images/runningExperiments/parameters_built_in.png){.img-responsive}


## Parameters View ## {#parameters-view}
The modeler can [define himself parameters](tutorials#DefiningParameters) that can be displayed in the GUI and that are sorted by categories. Note that the interface will depend on the data type of the parameter: for example, for integer or float parameters, a simple text box will be displayed whereas a color selector will be available for color parameters. The parameters value displayed are the initial value provided to the variables associated to the parameters in the model.

![images/parameters.png](gm_wiki/resources/images/runningExperiments/parameters.png){.img-responsive}
