...
<div class='gama-keyword-style' id ='391_47_608_statement-output-file'></div>
...
<div class='gama-keyword-style' id ='391_48_609_statement-overlay'></div>
### overlay  ## {#overlay}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_49_610_statement-parameter'></div>
### parameter  ## {#parameter}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_50_611_statement-perceive'></div>
### perceive  ## {#perceive}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_51_612_statement-permanent'></div>
### permanent  ## {#permanent}
#### Facets  ## {#facets}
...
* The `permanent` statement embeds statements: [display](references#display),  [inspect](references#inspect),  [monitor](references#monitor),  [output_file](references#output_file),  
...
<div class='gama-keyword-style' id ='391_52_613_statement-plan'></div>
### plan  ## {#plan}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_53_614_statement-put'></div>
### put  ## {#put}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_54_615_statement-reactive-tabu'></div>
### reactive_tabu  ## {#reactive-tabu}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_55_616_statement-reflex'></div>
### reflex  ## {#reflex}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_56_617_statement-release'></div>
### release  ## {#release}
#### Facets  ## {#facets}
...
* See also: [capture](references#capture), 
...
<div class='gama-keyword-style' id ='391_57_618_statement-remove'></div>
### remove  ## {#remove}
#### Facets  ## {#facets}
...
* See also: [add](references#add), [put](references#put), 
...
<div class='gama-keyword-style' id ='391_58_619_statement-return'></div>
### return  ## {#return}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_59_620_statement-rule'></div>
### rule  ## {#rule}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_60_621_statement-run'></div>
### run  ## {#run}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_61_622_statement-save'></div>
### save  ## {#save}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_62_623_statement-save-batch'></div>
...
<div class='gama-keyword-style' id ='391_63_624_statement-set'></div>
### set  ## {#set}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_64_625_statement-setup'></div>
### setup  ## {#setup}
#### Facets  ## {#facets}
...
* See also: [test](references#test), [assert](references#assert), 
...
<div class='gama-keyword-style' id ='391_65_626_statement-simulate'></div>
### simulate  ## {#simulate}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_66_627_statement-solve'></div>
### solve  ## {#solve}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_67_628_statement-species'></div>
### species  ## {#species}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_68_629_statement-state'></div>
### state  ## {#state}
#### Facets  ## {#facets}
...
* See also: [enter](references#enter), [exit](references#exit), [transition](references#transition), 

#### Embedments ## {#embedments}
* The `state` statement is of type: **Behavior**
* The `state` statement can be embedded into: fsm, Species, Experiment, Model, 
* The `state` statement embeds statements: [enter](references#enter),  [exit](references#exit),  
...
<div class='gama-keyword-style' id ='391_69_630_statement-status'></div>
### status  ## {#status}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_70_631_statement-switch'></div>
### switch  ## {#switch}
#### Facets  ## {#facets}
...
* See also: [match](references#match), [default](references#default), [if](references#if), 
...
* The `switch` statement embeds statements: [default](references#default),  [match](references#match),  
...
<div class='gama-keyword-style' id ='391_71_632_statement-tabu'></div>
### tabu  ## {#tabu}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_72_633_statement-task'></div>
### task  ## {#task}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_73_634_statement-test'></div>
### test  ## {#test}
#### Facets  ## {#facets}
...
* See also: [setup](references#setup), [assert](references#assert), 

#### Embedments ## {#embedments}
* The `test` statement is of type: **Behavior**
* The `test` statement can be embedded into: Species, Experiment, Model, 
* The `test` statement embeds statements: [assert](references#assert),  
...
<div class='gama-keyword-style' id ='391_74_635_statement-trace'></div>
### trace  ## {#trace}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_75_636_statement-transition'></div>
...
* See also: [enter](references#enter), [state](references#state), [exit](references#exit), 
...
<div class='gama-keyword-style' id ='391_76_637_statement-unconscious-contagion'></div>
### unconscious_contagion  ## {#unconscious-contagion}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_77_638_statement-user-command'></div>
...
* See also: [user_init](references#user_init), [user_panel](references#user_panel), [user_input](references#user_input), 
...
* The `user_command` statement embeds statements: [user_input](references#user_input),  
...
<div class='gama-keyword-style' id ='391_78_639_statement-user-init'></div>
### user_init  ## {#user-init}
#### Facets  ## {#facets}
...
* See also: [user_command](references#user_command), [user_init](references#user_init), [user_input](references#user_input), 

#### Embedments ## {#embedments}
* The `user_init` statement is of type: **Behavior**
* The `user_init` statement can be embedded into: Species, Experiment, Model, 
* The `user_init` statement embeds statements: [user_panel](references#user_panel),  
...
<div class='gama-keyword-style' id ='391_79_640_statement-user-input'></div>
...
* See also: [user_command](references#user_command), [user_init](references#user_init), [user_panel](references#user_panel), 
...
<div class='gama-keyword-style' id ='391_80_641_statement-user-panel'></div>
...
* The `user_panel` statement embeds statements: [user_command](references#user_command),  
...
<div class='gama-keyword-style' id ='391_81_642_statement-using'></div>
### using  ## {#using}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_82_643_statement-Variable-container'></div>
### Variable_container  ## {#variable-container}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_83_644_statement-Variable-number'></div>
...
<div class='gama-keyword-style' id ='391_84_645_statement-Variable-regular'></div>
...
<div class='gama-keyword-style' id ='391_85_646_statement-warn'></div>
### warn  ## {#warn}
#### Facets  ## {#facets}
...
<div class='gama-keyword-style' id ='391_86_647_statement-write'></div>
### write  ## {#write}
#### Facets  ## {#facets}
