...
Outside its _scope_ of validity, an expression cannot use a variable or an attribute directly. However, attributes can be used in a remote fashion by using a dotted notation on a given agent (see [here](references#Remote_Access)).


## Table of contents  ## {#table-of-contents}

* [Variables and Attributes](references#variables-and-attributes)
	* [Direct Access](references#direct-access)
	* [Remote Access](references#remote-access)
