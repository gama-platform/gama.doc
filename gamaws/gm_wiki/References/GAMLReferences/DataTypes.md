...
![images/types_hierarchy.png](gm_wiki/resources/images/gamlReferences/types_hierarchy.png){.img-responsive}



## Table of contents  ## {#table-of-contents}

* [Types (Under Construction)](references#types-under-construction)
	* [Primitive built-in types](references#primitive-built-in-types)
		* [bool](references#bool)
		* [float](references#float)
		* [int](references#int)
		* [string](references#string)
	* [Complex built-in types](references#complex-built-in-types)
		...
		* [Species names as types](references#species-names-as-types)
		* [topology](references#topology)
	* [Defining custom types](references#defining-custom-types)
...
[//]: # (keyword|type_float)
<div class='gama-keyword-style' id ='392_0_1549_type-float'></div>
### float ## {#float}
...
[//]: # (keyword|type_int)
<div class='gama-keyword-style' id ='392_1_1553_type-int'></div>
### int ## {#int}
...
[//]: # (keyword|type_string)
<div class='gama-keyword-style' id ='392_2_1566_type-string'></div>
### string ## {#string}
  ...
  * **Example:** see [string operators](references#Operators#strings-related-operators){.internal-link-anchor}.
...
[//]: # (keyword|type_agent)
<div class='gama-keyword-style' id ='392_3_1541_type-agent'></div>
### agent ## {#agent}
...
<div class='gama-keyword-style' id ='392_4_1544_type-container'></div>
### container ## {#container}
  ...
  * **See also:** [Container operators](references#Operators#containers-related-operators){.internal-link-anchor}
  * **Declaration:**
```
container c  <- [1,2,3];
...
[//]: # (keyword|type_file)
<div class='gama-keyword-style' id ='392_5_1548_type-file'></div>
### file ## {#file}
  ...
  * **See also:** [File operators](references#Operators#files-related-operators){.internal-link-anchor}
...
<div class='gama-keyword-style' id ='392_6_1551_type-geometry'></div>
### geometry ## {#geometry}
  ...
  * **See also:** [Spatial operators](references#Operators#spatial-operators){.internal-link-anchor}
...
[//]: # (keyword|type_graph)
<div class='gama-keyword-style' id ='392_7_1552_type-graph'></div>
### graph ## {#graph}
  ...
  * **See also:** [Graph operators](references#Operators#graph-related-operators){.internal-link-anchor}
...
[//]: # (keyword|type_list)
<div class='gama-keyword-style' id ='392_8_1554_type-list'></div>
### list ## {#list}
...
[//]: # (keyword|type_map)
<div class='gama-keyword-style' id ='392_9_1555_type-map'></div>
### map ## {#map}
...
[//]: # (keyword|type_matrix)
<div class='gama-keyword-style' id ='392_10_1556_type-matrix'></div>
### matrix ## {#matrix}
...
[//]: # (keyword|type_pair)
<div class='gama-keyword-style' id ='392_11_1558_type-pair'></div>
### pair ## {#pair}
...
[//]: # (keyword|type_path)
<div class='gama-keyword-style' id ='392_12_1559_type-path'></div>
### path ## {#path}
...
[//]: # (keyword|type_point)
<div class='gama-keyword-style' id ='392_13_1560_type-point'></div>
### point ## {#point}
...
[//]: # (keyword|type_rgb)
<div class='gama-keyword-style' id ='392_14_1563_type-rgb'></div>
### rgb ## {#rgb}
...
<div class='gama-keyword-style' id ='392_15_1565_type-species'></div>
### species ## {#species}
...
<div class='gama-keyword-style' id ='392_16_1567_type-topology'></div>
### topology ## {#topology}
