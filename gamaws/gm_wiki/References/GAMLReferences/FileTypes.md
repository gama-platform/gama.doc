...
<section class='concept-graph' markdown='1' id ='concept_393_0_39_load-complex-datas'>
...
* [File Types](references#file-types)
	* [Text File](references#text-file)
		* [Extensions](references#extensions)
		* [Content](references#content)
		* [Operators](references#operators)
	* [CSV File](references#csv-file)
		* [Extensions](references#extensions)
		* [Content](references#content)
		* [Operators](references#operators)
	* [Shapefile](references#shapefile)
		* [Extensions](references#extensions)
		* [Content](references#content)
		* [Operators](references#operators)
	* [OSM File](references#osm-file)
		* [Extensions](references#extensions)
		* [Content](references#content)
		* [Operators](references#operators)
	* [Grid File](references#grid-file)
		* [Extensions](references#extensions)
		* [Content](references#content)
		* [Operators](references#operators)
	* [Image File](references#image-file)
		* [Extensions](references#extensions)
		* [Content](references#content)
		* [Operators](references#operators)
	* [SVG File](references#svg-file)
		* [Extensions](references#extensions)
		* [Content](references#content)
		* [Operators](references#operators)
	* [Property File](references#property-file)
		* [Extensions](references#extensions)
		* [Content](references#content)
		* [Operators](references#operators)
	* [R File](references#r-file)
		* [Extensions](references#extensions)
		* [Content](references#content)
		* [Operators](references#operators)
	* [3DS File](references#3ds-file)
		* [Extensions](references#extensions)
		* [Content](references#content)
		* [Operators](references#operators)
	* [OBJ File](references#obj-file)
		* [Extensions](references#extensions)
		* [Content](references#content)
		* [Operators](references#operators)
...
Note that GAMA also integrates some operators to manage R scripts:
  * [R\_compute](references#Operators#R_compute){.internal-link-anchor}
  * [R\_compute\_param](references#Operators#R_compute_param){.internal-link-anchor}
