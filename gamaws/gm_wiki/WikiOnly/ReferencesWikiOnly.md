...
As stated in [the first page](wikionly#Overview), if you need to cite GAMA in a paper, we kindly ask you to use this reference:
...
## Papers about GAMA ## {#papers-about-gama}
  ...
  * [Grignard, Arnaud, Alexis Drogoul, and Jean-Daniel Zucker. "Online analysis and visualization of agent based models." Computational Science and Its Applications–ICCSA 2013. Springer Berlin Heidelberg, 2013. 662-672.](http://link.springer.com/chapter/10.1007/978-3-642-39637-3_52#page-1){.internal-link-anchor}
...
## Research papers that use GAMA as modeling/simulation support ## {#research-papers-that-use-gama-as-modelingsimulation-support}
**2014**
