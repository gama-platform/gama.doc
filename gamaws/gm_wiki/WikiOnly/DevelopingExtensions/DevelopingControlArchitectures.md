# Developing architecture ## {#developing-architecture}



In addition to existing [control architectures](G__BuiltInControlArchitectures), developers can add new ones.

Defining a new control architecture needs to [create new statements of type behavior](wikionly#DevelopingStatements) and included in species statements and to define how to manage their execution.
...
A control architecture is a Java class, that:
  * is annotated by the [@skill](wikionly#DevelopingIndexAnnotations#skill){.internal-link-anchor} annotation,
