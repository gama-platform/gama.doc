# How to write the Website Content ## {#how-to-write-the-website-content}
...
![resources/images/developpingExtension/tree_structure.png](gm_wiki/resources/images/developpingExtension/tree_structure.png){.img-responsive} 
...
#### startConcept/endConcept ## {#startconceptendconcept}
...
![resources/images/developpingExtension/website_generation_workflow.png](gm_wiki/resources/images/developpingExtension/website_generation_workflow.png){.img-responsive}

### The gama.documentation plugin ## {#the-gamadocumentation-plugin}

This plugin is used to [generate GAML documentation automatically in the markdown format](wikionly#Documentation), and copy paste the content to the wiki folder.
...
#### learningGraphDatabaseGenerator ## {#learninggraphdatabasegenerator}
...
#### modelLibraryGenerator ## {#modellibrarygenerator}
...
### The gama.wiki repository ## {#the-gamawiki-repository}
...
### The website repository ## {#the-website-repository}
...
![resources/images/developpingExtension/global_database.png](gm_wiki/resources/images/developpingExtension/global_database.png){.img-responsive}
...
![resources/images/developpingExtension/keyword_table.png](gm_wiki/resources/images/developpingExtension/keyword_table.png){.img-responsive}
...
![resources/images/developpingExtension/alias_table.png](gm_wiki/resources/images/developpingExtension/alias_table.png){.img-responsive}
...
![resources/images/developpingExtension/webpage_table.png](gm_wiki/resources/images/developpingExtension/webpage_table.png){.img-responsive}
...
![resources/images/developpingExtension/learningConcept_table.png](gm_wiki/resources/images/developpingExtension/learningConcept_table.png){.img-responsive}
...
#### Role of the documentation generation script in the construction of the database ## {#role-of-the-documentation-generation-script-in-the-construction-of-the-database}

As explained in the explication of the [documentation generation pages](wikionly#Documentation), the documentation generation script is used to generate the gaml references and the model library pages (in the markdown format with metadatas), but also to build two files **category.txt** and **keyword.xml**.
...
#### Preparation of the repository before the generation of the database ## {#preparation-of-the-repository-before-the-generation-of-the-database}
...
#### Role of the website content generation script in the construction of the database ## {#role-of-the-website-content-generation-script-in-the-construction-of-the-database}
...
### In the Model library ## {#in-the-model-library}
...
### In the GAML References ## {#in-the-gaml-references}
...
______________ _last update : 2016/04/11 12:06:01_
