# 3. Importation of GIS data ## {#3-importation-of-gis-data}
This third step illustrates how load GIS data and to agentify them.

![images/luneray3.tiff](gm_wiki/resources/images/tutorials/luneray3.tiff){.img-responsive}
...
We used here the [one_of](references#Operators#one_of){.internal-link-anchor} operator that returns a random element from a list and the [any_location_in](references#Operators#any_location_in){.internal-link-anchor} operator that returns a random location inside a geometry.
...
[Next step: Use of a graph to constraint the movements of people](tutorials#LuneraysFlu_step4)