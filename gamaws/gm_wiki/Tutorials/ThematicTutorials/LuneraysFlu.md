...
![images/Luneray.jpg](gm_wiki/resources/images/tutorials/Luneray.jpg){.img-responsive}
...
![images/Luneray.png](gm_wiki/resources/images/tutorials/Luneray.png){.img-responsive}
...
This tutorial is composed of 5 steps corresponding to 5 models. For each step we present its purpose, an explicit formulation and the corresponding GAML code.
  ...
  1. [Creation of a first basic disease spreading model](tutorials#LuneraysFlu_step1)
  1. [Definition of monitors and chart outputs](tutorials#LuneraysFlu_step2)
  1. [Importation of GIS data](tutorials#LuneraysFlu_step3)
  1. [Use of a graph to constraint the movements of people](tutorials#LuneraysFlu_step4)
  1. [Definition of 3D displays](tutorials#LuneraysFlu_step5)