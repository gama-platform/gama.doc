# 3. Prey Agent Behavior ## {#3-prey-agent-behavior}
...
### vegetation\_cell grid ## {#vegetation-cell-grid}
...
Also note the use of the [self](references#PseudoVariables#self){.internal-link-anchor} pseudo variable which is a reference to the agent currently executing the statement
