# 5. Predator Agent ## {#5-predator-agent}
...
![images/parent_species.png](gm_wiki/resources/images/tutorials/parent_species.png){.img-responsive}
...
### global init block ## {#global-init-block}
