...
<section class='concept-graph' markdown='1' id ='concept_25_0_34_multi-level'>
[//]: # (keyword|concept_multi_level)
<div class='gama-keyword-style' id ='25_0_73_concept-multi-level'></div>
# Multi-level architecture ## {#multi-level-architecture}
...
* [Declaration of micro-species](tutorials#declaration-of-micro-species)
* [Access to micro-agents / host agent](tutorials#access-to-micro-agents-host-agent)
* [Representation of an entity as different types of agent](tutorials#representation-of-an-entity-as-different-types-of-agent)
* [Dynamic migration of agents](tutorials#dynamic-migration-of-agents)
...
<div class='gama-keyword-style' id ='25_1_573_statement-capture'></div>
...
<div class='gama-keyword-style' id ='25_2_617_statement-release'></div>
...
<div class='gama-keyword-style' id ='25_3_605_statement-migrate'></div>
...
![images/multilevel_model.png](gm_wiki/resources/images/definingAdvancedSpecies/multilevel_model.png){.img-responsive}
