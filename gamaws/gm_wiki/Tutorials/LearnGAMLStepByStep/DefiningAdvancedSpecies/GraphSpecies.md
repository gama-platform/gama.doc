[//]: # (startConcept|graph)
<section class='concept-graph' markdown='1' id ='concept_23_0_10_graph'>
[//]: # (keyword|concept_graph)
<div class='gama-keyword-style' id ='23_0_47_concept-graph'></div>
[//]: # (keyword|concept_node)
<div class='gama-keyword-style' id ='23_1_76_concept-node'></div>
[//]: # (keyword|concept_edge)
<div class='gama-keyword-style' id ='23_2_36_concept-edge'></div>
# Graph Species ## {#graph-species}
[//]: # (keyword|type_graph)
<div class='gama-keyword-style' id ='23_3_1552_type-graph'></div>
[//]: # (keyword|concept_topology)
<div class='gama-keyword-style' id ='23_4_121_concept-topology'></div>
...
* [Declaration](tutorials#declaration)
  * [Declare a graph with handmade agents](tutorials#declare-a-graph-with-handmade-agents)
  * [Declare a graph by using an geometry file](tutorials#declare-a-graph-by-using-an-geometry-file)
  * [Declare a graph with nodes and edges](tutorials#declare-a-graph-with-nodes-and-edges)
* [Useful operators with graph](tutorials#useful-operators-with-graph)
  * [Knowing the degree of a node](tutorials#knowing-the-degree-of-a-node)
  * [Get the neighbors of a node](tutorials#get-the-neighbors-of-a-node)
  * [Compute the shortest path](tutorials#compute-the-shortest-path)
  * [Control the weight in graph](tutorials#control-the-weight-in-graph)
...
![graph_related_to.png](gm_wiki/resources/images/definingAdvancedSpecies/graph_related_to.png){.img-responsive}
...
![graph_related_to2.png](gm_wiki/resources/images/definingAdvancedSpecies/graph_related_to2.png){.img-responsive}
...
<div class='gama-keyword-style' id ='23_5_65_concept-load-file'></div>
[//]: # (keyword|operator_as_edge_graph)
<div class='gama-keyword-style' id ='23_6_187_operator-as-edge-graph'></div>
...
<div class='gama-keyword-style' id ='23_7_157_operator-add-node'></div>
[//]: # (keyword|operator_add_edge)
<div class='gama-keyword-style' id ='23_8_153_operator-add-edge'></div>
...
<div class='gama-keyword-style' id ='23_9_255_operator-degree-of'></div>
...
<div class='gama-keyword-style' id ='23_10_398_operator-neighbors-of'></div>
...
![graph_model.png](gm_wiki/resources/images/definingAdvancedSpecies/graph_model.png){.img-responsive}
...
<div class='gama-keyword-style' id ='23_11_100_concept-shortest-path'></div>
...
<div class='gama-keyword-style' id ='23_12_421_operator-path-between'></div>
...
<div class='gama-keyword-style' id ='23_13_423_operator-paths-between'></div>
...
![shortest_path.png](gm_wiki/resources/images/definingAdvancedSpecies/shortest_path.png){.img-responsive}
...
<div class='gama-keyword-style' id ='23_14_48_concept-graph-weight'></div>
[//]: # (keyword|operator_with_weights)
<div class='gama-keyword-style' id ='23_15_559_operator-with-weights'></div>
...
![path_weight.png](gm_wiki/resources/images/definingAdvancedSpecies/path_weight.png){.img-responsive}
