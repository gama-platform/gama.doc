...
<section class='concept-graph' markdown='1' id ='concept_30_0_16_3d-displays'>
[//]: # (keyword|concept_3d)
<div class='gama-keyword-style' id ='30_0_1_concept-3d'></div>
# Defining 3D Displays ## {#defining-3d-displays}

## Table of contents  ## {#table-of-contents}

* [OpenGL display](tutorials#opengl-display)
	* [Position](tutorials#position)
	* [Size](tutorials#size)
* [Camera](tutorials#camera)
* [Dynamic camera](tutorials#dynamic-camera)
	* [Camera position](tutorials#camera-position)
	* [Camera direction (Look Position)](tutorials#camera-direction-look-position)
	* [Camera orientation (Up Vector)](tutorials#camera-orientation-up-vector)
		* [Default view](tutorials#default-view)
		* [First person view](tutorials#first-person-view)
		* [Third Person view](tutorials#third-person-view)
* [Lighting](tutorials#lighting)

[//]: # (keyword|concept_opengl)
<div class='gama-keyword-style' id ='30_1_79_concept-opengl'></div>
...
The opengl display share most of the feature that the java2D offers and that are described [here](tutorials#DefiningDisplaysGeneralities).
...
![images/species_layer.png](gm_wiki/resources/images/definingGUIExperiment/species_layer.png){.img-responsive}


[//]: # (keyword|concept_camera)
<div class='gama-keyword-style' id ='30_2_15_concept-camera'></div>
## Camera ## {#camera}
...
[Arcball Camera](references#Displays#arcball-camera-commands){.internal-link-anchor}

[FreeFly Camera](references#Displays#freefly-camera-commands){.internal-link-anchor}
...
<div class='gama-keyword-style' id ='30_3_63_concept-light'></div>
## Lighting ## {#lighting}
