...
<section class='concept-graph' markdown='1' id ='concept_35_0_29_run-simulations-as-agents'>
# Run Several Simulations ## {#run-several-simulations}
...
* [Create a simulation](tutorials#create-a-simulation)
* [Manipulate simulations](tutorials#manipulate-simulations)
* [Random seed](tutorials#random-seed)
  * [Defining the seed from the model](tutorials#defining-the-seed-from-the-model)
  * [Defining the seed from the experiment](tutorials#defining-the-seed-from-the-experiment)
  * [Run several simulations with the same random numbers](tutorials#run-several-simulations-with-the-same-random-numbers)
  * [Change the RNG](tutorials#change-the-rng)

## Create a simulation ## {#create-a-simulation}

[//]: # (keyword|concept_world)
<div class='gama-keyword-style' id ='35_0_1679_concept-world'></div>
...
<div class='gama-keyword-style' id ='35_1_576_statement-create'></div>
[//]: # (keyword|concept_experiment)
<div class='gama-keyword-style' id ='35_2_39_concept-experiment'></div>
[//]: # (keyword|concept_multi_simulation)
<div class='gama-keyword-style' id ='35_3_1609_concept-multi-simulation'></div>
...
![resources/images/exploringModel/change_world.png](gm_wiki/resources/images/exploringModel/change_world.png){.img-responsive}
...
![resources/images/exploringModel/multi_foraging.jpg](gm_wiki/resources/images/exploringModel/multi_foraging.jpg){.img-responsive}

[//]: # (endConcept|run_simulations_as_agents)
</section>
[//]: # (startConcept|control_randomness)
<section class='concept-graph' markdown='1' id ='concept_35_1_30_control-randomness'>

[//]: # (keyword|concept_random)
<div class='gama-keyword-style' id ='35_4_89_concept-random'></div>
...
The experiment agent also have a built-in attribute `seed`. The value of this seed is defined in your [simulation preferences](references#Preferences#simulation){.internal-link-anchor}. The first simulation created is created **with the seed value of the experiment**.

The following sequence diagram can explain you better how the affectation of the seed attribute works :

![resources/images/exploringModel/sequence_diagram_seed_affectation.png](gm_wiki/resources/images/exploringModel/sequence_diagram_seed_affectation.png){.img-responsive}
...
![resources/images/exploringModel/same_simulation_one_agent.png](gm_wiki/resources/images/exploringModel/same_simulation_one_agent.png){.img-responsive}
...
![resources/images/exploringModel/same_simulation_2_species.png](gm_wiki/resources/images/exploringModel/same_simulation_2_species.png){.img-responsive}
