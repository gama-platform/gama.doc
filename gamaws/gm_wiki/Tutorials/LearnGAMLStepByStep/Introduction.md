...
* [Key Concepts (Under construction)](tutorials#key-concepts-under-construction)
	* [Lexical semantics of GAML](tutorials#lexical-semantics-of-gaml)
	* [Translation into a concrete syntax](tutorials#translation-into-a-concrete-syntax)
	* [Vocabulary correspondance with the object-oriented paradigm as in Java](tutorials#vocabulary-correspondance-with-the-object-oriented-paradigm-as-in-java)
	* [Vocabulary correspondance with the agent-based paradigm as in NetLogo](tutorials#vocabulary-correspondance-with-the-agent-based-paradigm-as-in-netlogo)
...
![framework.png](gm_wiki/resources/images/introduction/framework.png){.img-responsive}
...
![user_model.png](gm_wiki/resources/images/introduction/user_model.png){.img-responsive}
