...
<section class='concept-graph' markdown='1' id ='concept_45_0_12_diffusion'>
[//]: # (keyword|concept_diffusion)
<div class='gama-keyword-style' id ='45_0_1602_concept-diffusion'></div>
# Implementing diffusion ## {#implementing-diffusion}
[//]: # (keyword|concept_grid)
<div class='gama-keyword-style' id ='45_1_51_concept-grid'></div>
[//]: # (keyword|concept_math)
<div class='gama-keyword-style' id ='45_2_69_concept-math'></div>
[//]: # (keyword|concept_topology)
<div class='gama-keyword-style' id ='45_3_121_concept-topology'></div>

GAMA provides you the possibility to represent and simulate the diffusion of a variable through a grid topology. 

## Index ## {#index}

* [Diffuse statement](tutorials#diffuse-statement)
* [Diffusion with matrix](tutorials#diffusion-with-matrix)
  * [Diffusion matrix](tutorials#diffusion-matrix)
  * [Gradient matrix](tutorials#gradient-matrix)
  * [Compute multiple propagations at the same step](tutorials#compute-multiple-propagations-at-the-same-step)
  * [Executing several diffusion matrix](tutorials#execution-several-diffusion-matrix)
* [Diffusion with parameters](tutorials#diffusion-with-parameters)
* [Computation methods](tutorials#computation-methods)
  * [Convolution](tutorials#convolution)
  * [Dot Product](tutorials#dot-product)
* [Use mask](tutorials#using-mask)
  * [Generalities](tutorials#generalities)
  * [Tips](tutorials#tips)
* [Pseudo code](tutorials#pseudo-code)

## Diffuse statement ## {#diffuse-statement}

[//]: # (keyword|statement_diffuse)
<div class='gama-keyword-style' id ='45_4_580_statement-diffuse'></div>
...
<div class='gama-keyword-style' id ='45_5_70_concept-matrix'></div>
...
![resources/images/recipes/diffusion_computation.png](gm_wiki/resources/images/recipes/diffusion_computation.png){.img-responsive}
...
![resources/images/recipes/uniform_diffusion.png](gm_wiki/resources/images/recipes/uniform_diffusion.png){.img-responsive}

![resources/images/recipes/anisotropic_diffusion.png](gm_wiki/resources/images/recipes/anisotropic_diffusion.png){.img-responsive}
...
![resources/images/recipes/gradient_computation.png](gm_wiki/resources/images/recipes/gradient_computation.png){.img-responsive}
...
![resources/images/recipes/uniform_gradient.png](gm_wiki/resources/images/recipes/uniform_gradient.png){.img-responsive}

![resources/images/recipes/irregular_gradient.png](gm_wiki/resources/images/recipes/irregular_gradient.png){.img-responsive}
...
![resources/images/recipes/cycle_length.png](gm_wiki/resources/images/recipes/cycle_length.png){.img-responsive}
...
### Executing several diffusion matrix ## {#executing-several-diffusion-matrix}
...
![resources/images/recipes/addition_matrix.png](gm_wiki/resources/images/recipes/addition_matrix.png){.img-responsive}
...
![resources/images/recipes/gradient_computation_from_parameters.png](gm_wiki/resources/images/recipes/gradient_computation_from_parameters.png){.img-responsive}
...
![resources/images/recipes/convolution.png](gm_wiki/resources/images/recipes/convolution.png){.img-responsive}
...
![resources/images/recipes/dot_product.png](gm_wiki/resources/images/recipes/dot_product.png){.img-responsive}
...
![resources/images/recipes/simple_mask.png](gm_wiki/resources/images/recipes/simple_mask.png){.img-responsive}
...
![resources/images/recipes/mask_with_on_facet.png](gm_wiki/resources/images/recipes/mask_with_on_facet.png){.img-responsive}
...
#### Wall blocking the diffusion ## {#wall-blocking-the-diffusion}
...
![resources/images/recipes/wall_simulation.png](gm_wiki/resources/images/recipes/wall_simulation.png){.img-responsive}
...
#### Wind pushing the diffusion ## {#wind-pushing-the-diffusion}
...
![resources/images/recipes/diffusion_with_wind.png](gm_wiki/resources/images/recipes/diffusion_with_wind.png){.img-responsive}
...
![resources/images/recipes/uniform_diffusion_near_edge.png](gm_wiki/resources/images/recipes/uniform_diffusion_near_edge.png){.img-responsive}
...
![resources/images/recipes/uniform_diffusion_near_edge_with_mask.png](gm_wiki/resources/images/recipes/uniform_diffusion_near_edge_with_mask.png){.img-responsive}
