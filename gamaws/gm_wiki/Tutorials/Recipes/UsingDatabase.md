...
<section class='concept-graph' markdown='1' id ='concept_46_0_36_use-database'>
[//]: # (keyword|concept_database)
<div class='gama-keyword-style' id ='46_0_28_concept-database'></div>
# Using Database Access ## {#using-database-access}
...
## SQLSKILL ## {#sqlskill}
### Define a species that uses the SQLSKILL skill ## {#define-a-species-that-uses-the-sqlskill-skill}
...
### Map of connection parameters for SQL ## {#map-of-connection-parameters-for-sql}
...
### Test a connection to database ## {#test-a-connection-to-database}
**Syntax**:
...
### Select data from database ## {#select-data-from-database}
**Syntax**:
...
### Execution update commands ## {#execution-update-commands}
**Syntax**:
...
### Define a species that uses the MDXSKILL skill ## {#define-a-species-that-uses-the-mdxskill-skill}
Example of declaration:
```
entities {   
...
### Map of connection parameters for MDX ## {#map-of-connection-parameters-for-mdx}
...
### Test a connection to OLAP database ## {#test-a-connection-to-olap-database}
**Syntax**:
> _**testConnection** (params: connection`_`parameter)_
...
### Select data from OLAP database ## {#select-data-from-olap-database}
**Syntax**:
...
### Define a species that is an inheritance of agentDB ## {#define-a-species-that-is-an-inheritance-of-agentdb}
Example of declaration:
```
entities { 
...
### Check agent connected a database or not ## {#check-agent-connected-a-database-or-not}
...
### Get connection parameter ## {#get-connection-parameter}
...
### Retrieve data from database by using AgentDB ## {#retrieve-data-from-database-by-using-agentdb}
...
## Using database features to define environment or create species ## {#using-database-features-to-define-environment-or-create-species}
...
### Define the boundary of the environment from database ## {#define-the-boundary-of-the-environment-from-database}
...
### Create agents from the result of a select action ## {#create-agents-from-the-result-of-a-select-action}
...
### Save Geometry data to database ## {#save-geometry-data-to-database}
If we are familiar with how to create agents from a shapefile then it becomes very simple to create agents from select result. We can do as below:
